...
public interface DataManager {
    ...
    void close();
    public static DataManager create(String path, long mem, TransactionManagerImpl tm){
    ...
    public static DataManager open(String path, long mem, TransactionManagerImpl tm){
